    ...
    <div className="h-screen flex items-center justify-center bg-pattern bg-no-repeat bg-center">
      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className='flex flex-col items-center gap-3'>
          ...
          <p className="text-zinc-300 text-lg">Convide seus amigos e planeje sua proxíma viagem!</p>
        </div>
          ...
          {isGuestsInputOpen && (
            ...
            <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
              <button type='button' onClick={openGuestsModal} className='flex items-center gap-2 flex-1'>
                ...
                <span className='text-zinc-400 text-lg flex-1 text-left'>Quêm estará na viagem</span>
              </button>
              <div className='w-px h-6 bg-zinc-800' />
        ...
        <p className="text-sm text-zinc-500">Ao planejar sua viagem pela planner você automaticamente concorda <br className="bg-transparent text-lg placeholder-zinc-400"/> com nossos <a href="#" className="text-zinc-300 underline">termos de uso</a> e <a href="#" className="text-zinc-300 underline">política de privacidade</a>.</p>
      </div>
        ...
        <div className='fixed inset-0 bg-black/60 flex items-center justify-center'>
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            {emailsToInvite.map(email => {
                return (
                  <div key={email} className='flex flex-wrap gap-2'>
